...
class ExecutableModel(object):
    ...
    def getStoichiometryIds(self):
        ...
        """
        return _roadrunner.ExecutableModel_getStoichiometryIds(self)
...
class RoadRunner(object):
    ...
    def getStoichiometryIds(self):
        r"""returns the list of stoichiometry ids, either their names (if present), or 'stoich(species, rxn)'."""
        return _roadrunner.RoadRunner_getStoichiometryIds(self)
...
class SelectionRecord(object):
    ...
    INITIAL_STOICHIOMETRY = _roadrunner.SelectionRecord_INITIAL_STOICHIOMETRY
    r"""SelectionType for initial compartment values."""
